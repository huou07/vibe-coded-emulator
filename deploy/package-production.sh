...
COPYFILE_DISABLE=1 tar --no-xattrs \
  ...
  --exclude='*.DS_Store' \
  -cf "$SOURCE_ARCHIVE" -C "$ROOT" app.py netcode.py sync_engine.py qrcodegen.py LICENSE THIRD_PARTY_NOTICES.md static deploy README.md tools/verify-release-catalog.py
